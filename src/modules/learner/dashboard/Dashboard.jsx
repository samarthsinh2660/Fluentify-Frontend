...
import { LogOut, BookOpen, MessageCircle, Trophy, Map } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-green-50">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        ...
        {/* Two-column layout: courses left, recommendations right */}
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          {/* Recommendations — below courses on mobile, sidebar on lg+ */}
          {courses.length > 0 && (
            <div className="w-full lg:w-80 shrink-0 space-y-4">
              <RecommendationPanel courseId={courses[0].id} />
              <button
                onClick={() => navigate(`/knowledge-map/${courses[0].id}`)}
                className="w-full flex items-center justify-center gap-2 py-2.5 rounded-xl border border-green-200 text-green-700 text-sm font-medium hover:bg-green-50 transition-colors"
              >
